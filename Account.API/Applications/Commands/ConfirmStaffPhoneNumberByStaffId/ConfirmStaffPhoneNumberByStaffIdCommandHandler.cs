...
public class ConfirmStaffPhoneNumberByStaffIdCommandHandler(IUnitOfWork unitOfWork, AppService service) : IRequestHandler<ConfirmStaffPhoneNumberByStaffIdCommand, Result>
{
