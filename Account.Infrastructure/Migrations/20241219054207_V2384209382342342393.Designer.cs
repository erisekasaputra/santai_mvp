...
namespace Account.Infrastructure.Migrations
{
    ...
    [Migration("20241219054207_V2384209382342342393")]
            ...
            modelBuilder.Entity("Account.Domain.Aggregates.UserAggregate.MechanicUser", b =>
                {
                    ...
                    b.Property<int>("TotalCancelledJob")
                        .HasColumnType("int");

                    b.Property<int>("TotalCompletedJob")
                        .HasColumnType("int");

                    b.Property<int>("TotalEntireJob")
                        .HasColumnType("int");

                    b.Property<int>("TotalEntireJobBothCompleteIncomplete")
                        .HasColumnType("int");
