...
export let options = {
    stages: [
        { duration: '1m', target: 1000 }, // Meningkatkan ke 1 juta VUs dalam 1 menit
        { duration: '5m', target: 1000 }, // Mempertahankan 1 juta VUs selama 5 menit
        { duration: '1m', target: 0 }        // Mengurangi kembali ke 0 VUs dalam 1 menit
    ],
};
