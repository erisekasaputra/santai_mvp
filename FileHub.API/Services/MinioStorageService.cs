...
{
    private IOptionsMonitor<StorageConfiguration> _config;

    private IOptionsMonitor<EncryptionConfiguration> _kmsConfig;
    ...
    public MinioStorageService(IOptionsMonitor<StorageConfiguration> config, IOptionsMonitor<EncryptionConfiguration> kmsConfig)
    {
        _config = config;
