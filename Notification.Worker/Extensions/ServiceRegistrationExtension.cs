    ...
    { 
        ...
        services.AddMassTransit(x =>
        {
            ...
            var consumers = new (string QueueName, Type ConsumerType)[]
            {
                ...
                ("notification-service-mechanic-assigned-integration-event-queue",typeof(MechanicAssignedIntegrationEventConsumer)),
            ...
            x.UsingAmazonSqs((context, configure) =>
            {
                ...
                configure.UseMessageRetry(retryCfg => retryCfg.Interval(options.MessageRetryInterval, TimeSpan.FromSeconds(options.MessageRetryTimespan))); 
