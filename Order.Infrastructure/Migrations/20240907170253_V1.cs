        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancellationRefund_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderAmount_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    OrderAmount_Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GrandTotal_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    GrandTotal_Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Rating_Value = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orderings_Cancellations_CancellationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Value_Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MinimumOrderValue_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MinimumOrderValue_Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeeAmount_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Fees_Cancellations_OrderingId",
                        column: x => x.OrderingId,
                        principalTable: "Cancellations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseUnitPrice_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    BaseUnitPrice_Currency = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    Tax_Rate = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    Tax_TaxAmount_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orderings_CancellationId",
                table: "Orderings",
